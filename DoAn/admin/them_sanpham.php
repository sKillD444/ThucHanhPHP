                ...
                <div class="row mb-3">
                    <div class="col-md-6"><label>Loại</label>
                        <select name="ma_loai" class="form-select">
                            ...
                            while ($r = $l->fetch(PDO::FETCH_ASSOC)) echo "<option value='{$r['ma_loai']}'>{$r['tenloai']}</option>";
                            ?>
                        </select>
                    </div>
                    <div class="col-md-6"><label>Hãng</label>
                        <select name="ma_nsx" class="form-select">
                            ...
                            while ($r = $n->fetch(PDO::FETCH_ASSOC)) echo "<option value='{$r['ma_nsx']}'>{$r['tennsx']}</option>";
                            ?>
                        </select>
                    </div>
                </div>
