		...
		<form action="lab06_1.php" method="post" enctype="multipart/form-data">
			<table align="center">
				...
				<tr>
					<td>Thông tin:</td>
					<td>
						<textarea name="thong_tin" rows="5" cols="40"><?php echo $thong_tin; ?></textarea>
					</td>
				</tr>
				<tr>
	...
	?>
		<div class="info">
			...
			if ($err != "") echo $err;
				...
				echo "Mật khẩu đã mã hóa Ca2:" . md5(sha1($password1)) . "<br>";

				$kq = addslashes($thong_tin);//Them / 
				$kq = strip_tags($kq);// Xoa cac tag html
				$kq = nl2br($kq);// doi /n thanh <br>
				$kq = stripslashes($kq);//Xoa ca /
				echo "<b>Nội dung thong_tin đã xử lý:</b><br>";
				echo $kq . "<br><br>";
